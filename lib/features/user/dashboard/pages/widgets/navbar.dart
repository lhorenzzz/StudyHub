...
// navbar.dart
//
// Contains all navigation-related widgets:
//   DashboardNavbar   — top bar with logo, nav links, search, theme toggle
//   NavLogo           — StudyHub logo mark
//   NavLink           — individual nav tab button
//   NavSearchBar      — search input in navbar
//   NavIconBtn        — small square icon button (theme toggle, menu)
//   MobileDrawer      — slide-in drawer for narrow screens
//   SidebarLogo       — logo used inside the drawer
//   SidebarSectionLabel — section label inside drawer
//   SidebarItem       — nav item row inside drawer
//   SidebarCategoryItem — category row inside drawer (currently unused but kept)
// ─────────────────────────────────────────────────────────────────────────────
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          if (!isNarrow)
            // ── TODO (Backend Team) ────────────────────────────────────────
            // Replace 'LM' initials with real user initials from Firebase Auth:
            //
            ...
            //
            // Then use `initials` here instead of hardcoded 'LM'.
            // ────────────────────────────────────────────────────────────────
            MouseRegion(
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            // ── User info ───────────────────────────────────────────────────
            // ── TODO (Backend Team) ──────────────────────────────────────────
            // Replace hardcoded name/email with real user data:
            //   final user = FirebaseAuth.instance.currentUser;
            //   final name = user?.displayName ?? 'User';
            ...
            Padding(
              ...
              child: SidebarItem(
                ...
                onTap: () {
                  ...
                  // ── TODO (Backend Team) ──────────────────────────────────
                  // Add real logout here:
                  //   await FirebaseAuth.instance.signOut();
                  //   context.go('/login'); // using GoRouter
                  // ────────────────────────────────────────────────────────
                },
              ),
            ),
...
// ─── SidebarCategoryItem ──────────────────────────────────────────────────────
// Currently unused in main nav but kept for sidebar category filtering if needed.
